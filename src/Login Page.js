...
return (
    <div style={{marginLeft:595.3,marginTop:-17,border:"2px solid black",padding:10,width:305,height:450,display:"flex",flexDirection:"column",backgroundColor:"beige"}}>
